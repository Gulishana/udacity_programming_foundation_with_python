...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        #strailer_youtube_id = youtube_id_match.group(0) if youtube_id_match else None
...
# open_movies_page:
# input: takes in a list of movies as input
# output: creates and opens an HTML page or website, that shows the movie we gave it
def open_movies_page(movies):
    # Create or overwrite the output file
    output_file = open('fresh_tomatoes_Youku.html', 'w')
